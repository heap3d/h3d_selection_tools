...
# modo python
# EMAG
# select largest polygons 'flat' area in selected mesh
# ================================
...
@execution_time_alarm('Select Largest Polygons Area')
def main():
    scene = modo.Scene()
    ...
    for mesh in selected_meshes:
        center_polys = get_polygons_by_largest_flat_area(mesh, ANGLE_THRESHOLD)
        if not center_polys:
            continue
